...
\newcommand{\gram}[1]{\bsym{G}\spar{#1}}
...
\end{#1}}
\newcommand{\nullsp}[1]{\bsym{\mathrm{N}}\spar{#1}}
\newcommand{\colsp}[1]{\bsym{\mathrm{C}}\spar{#1}}
\newcommand{\func}[2]{\mathrm{#1}\spar{#2}}
